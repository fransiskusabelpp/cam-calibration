...
def calibrate(showPics=True):
    ...
    calibrationDir = os.path.join(root,'8-5')#ubah ke img kalo mau coba kalibrasi gambar yang abis ditangkap pake getImages.py
    #kalo gambar berhasil di kalibrasi, pindahin ke folder 8-5 dan ganti namanya sesuai lokasi fotonya
